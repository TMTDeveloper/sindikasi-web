...
if( ! empty( $options['option'] ) ) {
    ...
    $output .='<div class="ultimate-hover-item mg-col-md-'.$column.' mg-col-xs-12 mg-col-sm-6" style="padding:10px">';
    

    $output .= '<div class="hover-item" style="">';
    
    $output .= '<a href="#" onclick="return false;" class="ultimate-link noHover">';
        
    $output .= '<figure style="width:100%; height:300px" class="ultimate-hover effect-hover '.$effect.' ratiooriginal effect-fonts ultimate-lazyload">';

    
    $output .= '<img height:300px" object-fit:"scale-down"; data-src="'.$image[0].'" alt="'.$group['title'].'"/>';
